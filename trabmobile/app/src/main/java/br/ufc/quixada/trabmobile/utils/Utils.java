package br.ufc.quixada.trabmobile.utils;
...
public class Utils {
    ...
    public static String getLocalEmail(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.SHARED_PREFERENCES, Context.MODE_PRIVATE);
        return sharedPreferences.getString(Constants.PREFERENCES_USER_EMAIL, Constants.DEFAULT_EMAIL);
    }
